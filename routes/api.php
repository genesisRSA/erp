...
Route::get('/hris/attendances/raw_attendance/{site_code}/{date_from}/{date_to}', 'AttendancesController@raw_attendance');
Route::get('/hris/attendances/calc_attendance/{site_code}/{date_from}/{date_to}', 'AttendancesController@calc_attendance');
