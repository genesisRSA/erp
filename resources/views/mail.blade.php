@if($page=="leave")
   @if($status=="filed" && $receiver=="approver")
        ...
        <i>For more details you can click <a href="{{url('/')}}/hris/leaves/{{$ref_no}}/approval">here.</a></i>
   @elseif($status=="fit" && $receiver=="filer")  
        ...
        <i>For more details you can click <a href="{{url('/')}}/hris/leave/{{$ref_no}}">here.</a></i>
...
@elseif($page=="ob")
    ...
    @elseif($status=="approved" && $receiver=="filer")
        ...
        <i>For more details you can click <a href="{{url('/')}}/hris/ob/{{$ref_no}}">here.</a></i>
    @elseif($status=="declined" && $receiver=="filer")
        <h1>Good day, {{$requestor}}</h1>
...
@elseif($page=="cs")
    ...
    <i>For more details you can click <a href="{{url('/')}}/hris/css/{{$ref_no}}/approval">here.</a></i>
    @elseif($status=="manager" && $receiver=="approver")
        <h1>Good day, {{$approver}}</h1>
        <p>Please see below change shift request for your approval:<br><br>
            <strong>Ref. No: </strong>{{$ref_no}}<br>
    ...
    @elseif($status=="approved" && $receiver=="filer")
        ...
        <i>For more details you can click <a href="{{url('/')}}/hris/cs/{{$ref_no}}">here.</a></i>
    @elseif($status=="declined" && $receiver=="filer")
        <h1>Good day, {{$requestor}}</h1>
...
@elseif($page=="ot")
    ...
    <i>For more details you can click <a href="{{url('/')}}/hris/ots/{{$ref_no}}/approval">here.</a></i>
    @elseif($status=="manager" && $receiver=="approver")
        <h1>Good day, {{$approver}}</h1>
        <p>Please see below overtime request for your approval:<br><br>
            <strong>Ref. No: </strong>{{$ref_no}}<br>
