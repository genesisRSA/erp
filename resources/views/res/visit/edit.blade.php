...
@section('content')
  <div class="row blue-text text-darken-4 white" style="border-bottom: 1px solid rgba(0,0,0,0.14);">
    <div class="col s12 m12">
        <h4 class="title"><span class="grey-text darken-4">Sales<i class="material-icons">arrow_forward_ios</i></span><span class="grey-text darken-4">Sales Visit<i class="material-icons">arrow_forward_ios</i></span>Edit Visit</h4>
    </div>
  </div>
        ...
        <div class="card mb-3 col s12 m3 l3">
          <div class="card-body" style="height: 789px">
            <form method="POST" action="{{route('visit.patch')}}">
              ...
              <div class="row">
                <br>
                <input type="hidden" name="edit_lat" id="curr_lat" value="{{number_format($visits->loc_latitude, 10, '.', '')}}">
                <input  type="hidden" name="edit_long" id="curr_long" value="{{number_format($visits->loc_longhitude, 10, '.', '')}}">
                
                <div class="input-field col s12 m12 l12">
                  <input type="text" id="edit_visit_code" name="visit_code" value="{{$visits->visit_code}}" class="grey lighten-4" readonly/>
                ...
                <div class="input-field col s12 m12 l12">
                  <textarea id="edit_current_loc" name="current_loc" class="materialize-textarea grey lighten-4" placeholder="Amkor P3/P4" required readonly>{{$visits->current_location}}</textarea>
                  <label for="current_loc">Current Location<sup class="red-text">*</sup></label>
                </div>

                <div class="input-field col s12 m12 l12">
                  <textarea id="edit_complete_address" name="complete_address" class="materialize-textarea"  placeholder="PTC" required>{{$visits->complete_address}}</textarea>
                  <label for="complete_address">Complete Address<sup class="red-text">*</sup></label>
                </div>

                <div class="input-field col s12 m12 l12">
                  <textarea id="edit_visit_purpose" name="visit_purpose" class="materialize-textarea"  placeholder="On-site Visit" required>{{$visits->visit_purpose}}</textarea>
  ...
  <script type="text/javascript">
    ...
    var searchInput = 'edit_complete_address';
