...
@section('content')
      ...
      <div class="modal-content" style="padding-bottom: 0px;">
        ...
        <div id="items" name="items">
          ...
          <div class="row" style="margin-bottom: 0px;">
            ...
            {{-- <div class="input-field col s12 m6 l6 right-align" style="display: none" id="reset">
              <button type="button" class="orange waves-effect waves-light btn right-align" id="btnReset"><i class="material-icons left">loop</i>Reset</button>
            </div> --}}
          </div>
  ...
  var receiving = $('#receiving-dt').DataTable({
        ...
        "columns": [
            ...
            {   "data": "id",
                "render": function ( data, type, row, meta ) {
                  // return  '<a href="#" class="btn-small amber darken3 waves-effect waves-dark" onclick="editReceiving('+data+')"><i class="material-icons">create</i></a> <a href="#" class="btn-small red waves-effect waves-light" onclick="deleteReceiving('+data+')"><i class="material-icons">delete</i></a> <a href="#" class="btn-small blue waves-effect waves-light" onclick="printModal('+data+')"><i class="material-icons">print</i></a>';
