...
@section('content')<body oncontextmenu="return false;">
  <div class="row blue-text text-darken-4 white" style="border-bottom: 1px solid rgba(0,0,0,0.14);">
    <div class="col s12 m12">
        <h4 class="title"><span class="grey-text darken-4">Document Control Centre<i class="material-icons">arrow_forward_ios</i></span><span class="grey-text darken-4">Drawings<i class="material-icons">arrow_forward_ios</i></span>Master Copy</h4>
    </div>
  </div>
    ...
    <div class="m-3 main-content">  
      <div class="row">
            ...
            <form method="POST" enctype="multipart/form-data">
              <div class="row">
                ...
                <div class="row">
                  ...
                  <embed
                      src="/reiss/drawing/pdf/{{$drawings->id}}/master#toolbar=0"
                      style="width:95%; 
                            height:90%; 
              ...
              <div class="row">
                ...
                <div class="col s12 m3 l3 right-align">
                  <a href="#!" onclick="CreateMaster({{$drawings->id}});" class="green waves-effect waves-dark btn" style="width: 100%"><i class="material-icons left">add_box</i>Create Copy</a>
                </div>
        ...
        <div id="masterModal" class="modal bottom-sheet">
          <form method="POST" action="{{route('drawing.makemaster')}}">
              @csrf
              <div class="modal-content">
                  ...
                  <div class="row">
                      <div class="col s12 m6">
                          ...
                          <input type="hidden" name="revision_no"        id="m_ecn_code"     value="{{$drawings->revision_no}}">
                          <input type="hidden" name="ecn_code"        id="m_ecn_code"     value="{{$drawings->ecn_code}}">
                          <input type="hidden" name="part_name"  id="m_part_name" value="{{$drawings->part_name}}">
                          <input type="hidden" name="cust_code"  id="m_cust_code" value="{{$drawings->cust_code}}">
                          <input type="hidden" name="project_code"  id="m_project_code" value="{{$drawings->project_code}}"> 
                          <input type="hidden" name="drawing_no"     id="m_drawing_no"    value="{{$drawings->drawing_no}}">
                          <input type="hidden" name="dept"     id="m_dept"    value="{{$employee->dept_code}}">
                          <input type="hidden" name="designer"   id="m_designer"  value="{{$drawings->created_by}}">

                          <p>Are you sure you want to create a master copy for this <strong>drawing</strong>?</p>
                      </div>
                  </div>
              </div>
