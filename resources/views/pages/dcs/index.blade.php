    ...
    <body>
        <div class="container-fluid">
            <div class="d-flex flex-sm-row flex-md-column flex-lg-row flex-column" style="min-height:100vh;">
                ...
                <div class="row bg-blue align-self-stretch" style="min-width:30%;">
                    <div class="col-12 align-self-center">
                        <div class="form-group mt-3">
                            <div class="container">
                                <form method="POST" action="{{ route('dcs.login') }}">
                                    @csrf
                                    <h2 class="text-center text-white">
                                        <img src="{{url('/images/rgclogo.png')}}" alt="Logo" style="max-height:70px;"><br>Welcome to DCS
                                    </h2>
                                    ...
                                    <div class="form-group row">
                                        <div class="input-group mt-3">
                                            ...
                                            <input type="text" name="email" class="form-control{{ $errors->has('username') || $errors->has('email') ? ' is-invalid' : '' }}" placeholder="Username">
                                        </div>
                                    </div>
                                    <div class="form-group row">
