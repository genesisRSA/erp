...
@section('content')
    <div class="card mb-3">
        <div class="card-body">
            <h3><a href="{{ $ot->status == 'Posted' ? url()->previous().'#otposted' : url()->previous().'#ot' }}" class="mr-3"><i class="fas fa-arrow-left"></i></a> Overtime : {{$ot->ref_no}}</h3>
            <hr>
            @if ($errors->any())
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        @elseif($ot->status == 'Declined' || $ot->status == 'Voided')
