            ...
            <form method="POST" action="{{ route('leave.post', $leave->id) }}" enctype="multipart/form-data">
                ...
                <div class="modal fade" id="voidModal" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Void Leave</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                Are you sure you want to void this leave?
                            </div>
                            <div class="modal-footer">
                                <button type="submit" class="btn btn-success" name="void" value="posted">Yes</button>
                                <button type="button" class="btn btn-danger" data-dismiss="modal">No</button>
                            </div>
                        </div>
                    </div>
