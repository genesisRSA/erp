                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        @if($ob->approver_employee)
                                            <a href="/{{$ob->approver_employee->emp_photo}}" target="_blank"><img src="/{{$ob->approver_employee->emp_photo}}" class="img-fluid rounded-circle bg-dark" style="height:48px;"/></a> <span class="badge badge-secondary">{{$ob->approver_employee->full_name}}</span>
                                        @else
                                            N/A
                                        @endif
                                    </div>
