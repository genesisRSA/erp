                            ...
                            <div class="row pt-3 mb-3">
                                <div class="col-md-3 border-right">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step=".01" class="form-control" min="0" name="sick_leave" value="{{ old('sick_leave') ? old('sick_leave') : $leave_credits->sick_leave}}"/>
                                    </div>
                                    <div class="form-group">
                                        <label>Admin Leave <sup class="text-danger">*</sup></label>
                                        <input type="number" step=".01" class="form-control" min="0" name="admin_leave" value="{{ old('admin_leave') ? old('admin_leave') : $leave_credits->admin_leave}}"/>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-md-3 border-right">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step=".01" class="form-control" min="0" name="vacation_leave" value="{{ old('vacation_leave') ? old('vacation_leave') : $leave_credits->vacation_leave}}"/>
                                    </div>
                                    <div class="form-group">
                                        <label>Bereavement Leave <sup class="text-danger">*</sup></label>
                                        <input type="number" step=".01" class="form-control" min="0" name="bereavement_leave" value="{{ old('bereavement_leave') ? old('bereavement_leave') : $leave_credits->bereavement_leave}}"/>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-md-3 border-right">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step=".01" class="form-control" min="0" name="solo_parent_leave" value="{{ old('solo_parent_leave') ? old('solo_parent_leave') : $leave_credits->solo_parent_leave}}"/>
                                    </div>
                                    <div class="form-group">
                                        <label>Birthday Leave <sup class="text-danger">*</sup></label>
                                        <input type="number" step=".01" class="form-control" min="0" name="bday_leave" value="{{ old('bday_leave') ? old('bday_leave') : $leave_credits->bday_leave}}"/>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step=".01" class="form-control" min="0" name="maternity_leave" id="maternity_leave" value="{{ old('maternity_leave') ? old('maternity_leave') : $leave_credits->maternity_leave}}"/>
                                    </div>
                                    <div class="form-group">
                                        <label>Paternity Leave <sup class="text-danger">*</sup></label>
                                        <input type="number" step=".01" class="form-control" min="0" name="paternity_leave" id="paternity_leave" value="{{ old('paternity_leave') ? old('paternity_leave') : $leave_credits->paternity_leave}}"/>
                                    </div>
                                </div>
                            </div>
                        </div>
